...
def parse_arguments():
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=32, help='Size of batch for training.')
    ...
    parser.add_argument('-lr', '--learning_rate', type=float, default=0.01, help='Choose learning rate for training.')
    parser.add_argument('-wd', '--weight_decay', type=float, default=0.1, help='Weight decay for L2 regulrization.')
    parser.add_argument('-nhl', '--num_layers', type=int, default=2, help='Choose the number of hidden layers in the model.')
    parser.add_argument('-sz', '--hidden_size', type=int, nargs='+', default=[128, 64], help='List of hidden layer sizes.')
    ...
    parser.add_argument('-w_i', '--weight_init', type=str, default='random', choices=['random', 'xavier', 'zero'], help='Choose the weight initialization strategy.')
